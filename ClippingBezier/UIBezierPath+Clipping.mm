...
- (NSArray<DKUIBezierPathIntersectionPoint *> *)findIntersectionsWithClosedPath:(UIBezierPath *)closedPath andBeginsInside:(BOOL *)beginsInside
{
    ...
    __block CGFloat path2EstimatedLength = path2.length;
        ...
        [path1 iteratePathWithBlock:^(CGPathElement path1Element, NSUInteger path1ElementIndex) {
            ...
            if (path1Element.type != kCGPathElementMoveToPoint) {
                ...
                if (CGRectIntersectsRect(path1ElementBounds, path2Bounds)) {
                    ...
                    if (intersectionFound) {
                        for (long i = currentSubPathRange.location; i < currentSubPathRange.location + currentSubPathRange.length; i++) {
...
//                                     between these curves
                                ...
                                for (NSValue *val in intersections) {
                                    ...
                                    CGFloat lenTillPath2Inter = path2LengthBeforeElement + tValue2 * path2ElementLength;

                                    DKUIBezierPathIntersectionPoint *inter = [DKUIBezierPathIntersectionPoint
                                                                              intersectionAtElementIndex:path1ElementIndex
                                                                              andTValue:tValue1
                                                                              withElementIndex:i
                                                                              andTValue:tValue2
